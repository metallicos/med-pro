...
import com.medicalappointment.controller.ControllerFactory;
...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws IOException, SQLException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/medicalappointment/view/login_view.fxml"));

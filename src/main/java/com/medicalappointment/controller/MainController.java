...
public class MainController {
    ...
    private void handleLogout(ActionEvent event) {
        try {
            ...
            // Load login view
            Parent root = FXMLLoader.load(getClass().getResource("/com/medicalappointment/view/login_view.fxml"));
    ...
    private void handleManagePatients(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/medicalappointment/view/patient_view.fxml"));
    ...
    private void handleManageMedecins(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/medicalappointment/view/medecin_view.fxml"));
            Stage stage = (Stage) ((event.getSource() instanceof Button)
                ? ((Button) event.getSource()).getScene().getWindow()
                : ((MenuItem) event.getSource()).getParentPopup().getOwnerWindow());
    ...
    private void handleManageRendezVous(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/medicalappointment/view/rendezvous_view.fxml"));
            Stage stage = (Stage) ((event.getSource() instanceof Button)
                ? ((Button) event.getSource()).getScene().getWindow()
                : ((MenuItem) event.getSource()).getParentPopup().getOwnerWindow());
            stage.setScene(new Scene(root, 800, 600));

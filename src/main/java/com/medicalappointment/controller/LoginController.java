...
public class LoginController {
    ...
    public LoginController() {
        try {
            com.medicalappointment.dao.IDatabaseConnectionManager dbManager = 
                com.medicalappointment.dao.DatabaseConnectionManager.getInstance();
            com.medicalappointment.dao.IUserDAO userDAO = 
                new com.medicalappointment.dao.UserDAOImpl(dbManager);
